    ...
    <div
      ...
      <div
        ...
        <div style="font-size:22px !important;font-weight: bold;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          ${msg("mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.title", organization)}
        </div>
      </div>
      <div style="padding: 30px;">
        ...
        <p style="margin: 0 0 30px;">
          ${msg("mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.body", title)}
        </p>
        <p style="margin: 0 0 30px;">
          ${msg("mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.review")}
        </p>
        <p style="margin: 0 0 30px;">
        ...
        <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank"
          ...
          ${msg("mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.link")}</a>
      </p>
      </div>
    </div>
