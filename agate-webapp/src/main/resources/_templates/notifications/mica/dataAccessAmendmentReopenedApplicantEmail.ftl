    ...
    <div
      ...
      <div
        ...
        <div style="font-size:22px !important;font-weight: bold;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          ${msg("mica.email.dataAccessRequestAmendmentReopenedApplicant.title", organization)}
        </div>
      </div>
      <div style="padding: 30px;">
        ...
        <p style="margin: 0 0 30px;">
          ${msg("mica.email.dataAccessRequestAmendmentReopenedApplicant.body",title)}
        </p>
        <p style="margin: 0 0 30px;">
          ${msg("mica.email.dataAccessRequestAmendmentReopenedApplicant.review")}
        </p>
        <p style="margin: 0 0 30px;">
        ...
        <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank"
          ...
          ${msg("mica.email.dataAccessRequestAmendmentReopenedApplicant.link")}</a>
      </p>
      </div>
    </div>
