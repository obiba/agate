    ...
    <div
      ...
      <div
        ...
        <h3 style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          ${msg("mica.email.dataAccessRequestAmendmentCommentAdded.title", organization)}
        </h3>
      </div>
      <div style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          ${msg("mica.email.dataAccessRequestAmendmentCommentAdded.body", title!id)}
        </p>
        <p style="margin: 0 0 10px;">
        </p><p style="margin: auto;text-align: center;">
        <a href="${publicUrl}/data-access-comments/${id}" target="_blank"
          ...
          ${msg("mica.email.dataAccessRequestAmendmentCommentAdded.link")}</a>
      </p>
      </div>
    </div>
