...
<head>
  ...
  <title>${config.name!""} | <@message "forgot-password-title"/></title>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"><@message "forgot-password"/></p>

      <div id="alertFailure" class="alert alert-danger d-none">
        <small><@message "forgot-password-failed"/></small>
      </div>
...
<script>
  agatejs.forgotPassword("#form", function() {
