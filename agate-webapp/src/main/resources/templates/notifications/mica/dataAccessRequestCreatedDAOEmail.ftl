  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3 style="font-family: &quot;Lato&quot;,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;" th:text="#{mica.email.dataAccessRequestCreatedDAO.title(${organization})}">
      ...
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;" th:utext="#{mica.email.dataAccessRequestCreatedDAO.body(${id})}">
          The data access request "<strong>(id)</strong>" has been created (note that this is a work in progress which has not been submitted yet).
        </p>
        <p style="margin: 0 0 10px;">
        </p><p style="margin: auto;text-align: center;">
        <!-- Mica link -->
        <a href="" th:href="@{${publicUrl} + '/data-access/' + ${id}}" target="_blank"
          style="color: #ffffff;text-decoration: none;display: inline-block;margin-bottom: 0;font-weight: normal;text-align: center;vertical-align: middle;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;background: #2c3e50 none;white-space: nowrap;padding: 10px 15px;font-size: 15px;line-height: 1.5;border-radius: 4px;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;border: 1px solid #2c3e50;" th:text="#{mica.email.dataAccessRequestCreatedDAO.link}">View Request</a>
      </p>
      </div>
    </div>
