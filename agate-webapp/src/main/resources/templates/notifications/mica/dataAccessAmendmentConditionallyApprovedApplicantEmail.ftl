  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3 style="font-family: &quot;Lato&quot;,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;" th:text="#{mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.title(${organization})}">
      ...
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;" th:utext="#{mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.body(${title})}">
        ...
        <p style="margin: 0 0 10px;" th:text="#{mica.email.dataAccessRequestAmendmentConditionallyApprovedApplicant.review}">
