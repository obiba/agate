  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3 style="font-family: &quot;Lato&quot;,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;" th:text="#{mica.email.fileStatusChanged.title(${organization})}">
          <span>(organization)</span> - File
        </h3>
      </div>
      <div style="padding: 15px;">
        ...
        <div th:switch="${status}" style="margin: 0 0 10px;">
          <p th:case="DRAFT" th:text="#{mica.email.fileStatusChanged.body.draft}">
            A file is ready to be edited.
          </p>
          <p th:case="UNDER_REVIEW" th:text="#{mica.email.fileStatusChanged.body.underReview}">
            A file is ready to be reviewed. You can now approve or reject its publication.
          </p>
          <p th:case="'DELETED'" th:text="#{mica.email.fileStatusChanged.body.deleted}">
            A file was marked as being deleted. You can now delete it permanently.
          </p>
          <p th:case="*" th:utext="#{mica.email.fileStatusChanged.body.other(${status})}">
            A file status was changed to <strong>(status)</strong>.
          </p>
        </div>
