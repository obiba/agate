  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3 style="font-family: &quot;Lato&quot;,&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;" th:text="#{mica.email.dataAccessRequestFeasibilityReopenedApplicant.title(${organization})}">
      ...
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;" th:utext="#{mica.email.dataAccessRequestFeasibilityReopenedApplicant.body(${title})}">
          The Data Access Office has reopened your data access feasibility inquiry "<strong>(title)</strong>".
          Modifications are to be made before resubmitting this feasibility inquiry.
        </p>
        <p style="margin: 0 0 10px;" th:text="#{mica.email.dataAccessRequestFeasibilityReopenedApplicant.review}">
