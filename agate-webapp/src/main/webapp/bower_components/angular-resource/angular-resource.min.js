...
(function (H, a, A) {
  ...
  function D(p, g) {
    g = g || {};
    a.forEach(g, function (a, c) {delete g[c]});
  ...
  a.module("ngResource", ["ng"]).factory("$resource", ["$http", "$q", function (p, g) {
    ...
    function t(n, w, l) {
      ...
      function e(a) {return a.resource}
      ...
      s(l, function (h, d) {
        ...
        f[d] = function (b, d, k, w) {
          ...
          s(h, function (a, b) {"params" != b && ("isArray" != b && "interceptor" != b) && (z[b] = G(a))});
          c && (z.data = n);
          ...
          q = p(z).then(function (b) {
            ...
            if (d) {
              ...
              h.isArray ? (m.length = 0, s(d, function (b) {m.push(new f(b))})) : (D(d, m), m.$promise = k)
            }
            m.$resolved = !0;
            b.resource = m;
            return b
      ...
      f.bind = function (a) {return t(n, x({}, w, a), l)};
      return f
    }
    ...
    c.prototype = {setUrlParams: function (c, g, l) {
      ...
      s(r.urlParams, function (d, c) {
        f = g.hasOwnProperty(c) ?
          g[c] : r.defaults[c];
        a.isDefined(f) && null !== f ? (p = encodeURIComponent(f).replace(/%40/gi, "@").replace(/%3A/gi, ":").replace(/%24/g, "$").replace(/%2C/gi, ",").replace(/%20/g, "%20").replace(/%26/gi, "&").replace(/%3D/gi, "=").replace(/%2B/gi, "+"), e = e.replace(RegExp(":" + c + "(\\W|$)", "g"), function (a, c) {return p + c})) : e = e.replace(RegExp("(/?):" + c + "(\\W|$)", "g"), function (a, c, d) {return"/" == d.charAt(0) ? d : c + d})
      });
      e = e.replace(/\/+$/, "") || "/";
      e = e.replace(/\/\.(?=\w+($|\?))/, ".");
      c.url = e.replace(/\/\\\./, "/.");
