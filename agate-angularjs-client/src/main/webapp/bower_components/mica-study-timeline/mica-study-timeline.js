...
(function ($) {
   ...
   * @constructor
   */
  $.AgateTimeline = function (dtoParser) {
  ...
  $.AgateTimeline.prototype = {
    ...
    create: function (selectee, studyDto) {
      ...
      var chart = d3.timeline()
        ...
        .rotateTicks(timelineData.max > $.AgateTimeline.defaultOptions.maxMonths ? 45 : 0)
