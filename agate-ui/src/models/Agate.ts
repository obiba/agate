...
/**
 * Kept in sync by hand with the message of the same name in obiba-commons' OIDCDtos.proto: the agate-ui build
 * (agate-ui/Makefile, target "proto") only generates TypeScript from this file, not from other repos.
 */
...
export interface ApplicationDto_RealmGroupsDto {
  realm: string;
  groups: string[];
}
