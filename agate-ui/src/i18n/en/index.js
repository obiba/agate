export default {
  ...
  application: {
    ...
    notifications_template: 'Fallback notification templates',
    notifications_template_hint: 'Templates are looked up in this application\'s own folder first; missing ones fall back to the selected folder. "None": no fallback.',
    notifications_template_none: 'None',
