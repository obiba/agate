export default {
  ...
  system: {
    ...
    signup_blacklist_hint: "Liste des domaines de courriel interdits pour l'inscription.",
    ...
    signup_whitelist_hint: "Liste des domaines de courriel autorisés pour l'inscription.",
