export default {
  ...
  application: {
    ...
    notifications_template: 'Modèles de notification de repli',
    notifications_template_hint: "Les modèles sont d'abord recherchés dans le dossier propre à cette application ; ceux qui manquent sont pris dans le dossier sélectionné. « Aucun » : pas de repli.",
    notifications_template_none: 'Aucun',
