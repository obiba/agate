...
class StudyDtos {
  ...
  @NotNull
  Agate.StudyDto asDto(@NotNull Study study, Timestamped studyState) {
    Agate.StudyDto.Builder builder = Agate.StudyDto.newBuilder();
    ...
    if(study.getAttachments() != null) {
      builder.addAllAttachments(
          study.getAttachments().stream().map(attachmentDtos::asDto).collect(Collectors.<Agate.AttachmentDto>toList()));
    }
  ...
  @NotNull
  Study fromDto(@NotNull Agate.StudyDtoOrBuilder dto) {
  ...
  @NotNull
  private Agate.StudyDto.StudyMethodsDto asDto(@NotNull Study.StudyMethods studyMethods) {
    Agate.StudyDto.StudyMethodsDto.Builder builder = Agate.StudyDto.StudyMethodsDto.newBuilder();
  ...
  @NotNull
  private Study.StudyMethods fromDto(@NotNull Agate.StudyDto.StudyMethodsDtoOrBuilder dto) {
