...
import org.obiba.agate.domain.DataCollectionEvent;
import org.obiba.agate.domain.AgateConfig;
import org.obiba.agate.domain.NumberOfParticipants;
import org.obiba.agate.domain.Population;
...
import org.obiba.agate.repository.StudyStateRepository;
import org.obiba.agate.service.GitService;
...
import static org.obiba.agate.domain.LocalizedString.en;
import static org.obiba.agate.domain.Population.Recruitment;
import static org.obiba.agate.domain.Study.StudyMethods;
...
public class StudyDtosTest {
  ...
  public void before() {
    ...
    when(agateConfigService.getConfig()).thenReturn(config);
  }
  ...
  public void test_required_only_dto() throws Exception {
    ...
    Agate.StudyDto dto = dtos.asDto(study);
  ...
  private void assertTimestamps(Timestamped study, Agate.StudyDtoOrBuilder dto) {
  ...
  private Study createStudy() {
    ...
    study.setMaelstromAuthorization(createAuthorization("agate"));
  ...
  @Configuration
  @ComponentScan("org.obiba.agate.web.model")
  static class Config {
    ...
    @Bean
    public AgateConfigService agateConfigService() {
      return Mockito.mock(AgateConfigService.class);
    }
    ...
    @Bean
    public AgateConfigRepository agateConfigRepository() {
      return Mockito.mock(AgateConfigRepository.class);
    }
